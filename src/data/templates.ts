...
export const FiftyNordicTemplates: DesignTemplate[] = [
  // --- REMIXED & INSTALLED PREMIUM CORES ---
  {
    ...
    tagline: "Bright high-contrast product loops modeled on classic Tailwind structures",
    price: "€89",
    fonts: { display: "Space Grotesk", body: "Inter" },
    colors: { bg: "#FCFCFA", text: "#1A1A1A", accent: "#3B82F6" },
    philosophy: "Bright high-contrast product loops modeled on classic Tailwind structures with direct responsive grid alignments.",
    items: [
  ...
  },
  {
    ...
    tagline: "Large, heavy editorial layouts sporting Norwegian Grotesk typography",
    price: "€149",
    fonts: { display: "Space Grotesk", body: "JetBrains Mono" },
    colors: { bg: "#0E0E10", text: "#F3F4F6", accent: "#FA4616" },
    philosophy: "Large, heavy editorial layouts sporting Norwegian Grotesk typography with strict spacing, bold visual volumes, and flawless hierarchy scales.",
    items: [
  ...
  },
  {
    ...
    platform: "Shopify",
    style: "warm_scandinavian",
    tagline: "Timeless beige boutique tones, handsewn flax-linen web details, and elegant cards",
    price: "€129",
    fonts: { display: "Playfair Display", body: "Inter" },
    colors: { bg: "#FAF8F5", text: "#222222", accent: "#9D846F" },
    philosophy: "Timeless beige boutique tones, handsewn flax-linen web details, and elegant cards inspired by classical high-end Parisian-Scandinavian collections.",
    items: [
  ...
  },
  {
    ...
    platform: "Webflow",
    style: "warm_scandinavian",
    tagline: "Beautiful Swiss serif typography paired with contrasting color-block panels",
    price: "€99",
    fonts: { display: "Playfair Display", body: "Inter" },
    colors: { bg: "#F4EFEA", text: "#3C3228", accent: "#C8102E" },
    philosophy: "Beautiful Swiss serif typography paired with contrasting color-block panels characteristic of Atelier Mond's physical print shop and clay collection.",
    items: [
  ...
  },
  {
    ...
    platform: "Shopify",
    style: "brutalist_copenhagen",
    tagline: "Copenhagen technical designs with strict grid borders and terminal-inspired steel utility accents",
    price: "€119",
    fonts: { display: "Space Grotesk", body: "JetBrains Mono" },
    colors: { bg: "#1C1C1E", text: "#E5E5EA", accent: "#10B981" },
    philosophy: "Copenhagen technical designs with strict grid borders and terminal-inspired steel utility accents for elite shop storefronts and developers.",
    items: [
